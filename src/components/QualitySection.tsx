    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Qualidade em cada detalhe</h2>
        ...
        <div className="relative overflow-hidden rounded-lg shadow-2xl h-[400px] md:h-[500px]">
          <img
            src={sofaDetailImage}
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-transparent flex items-center">
            <div className="container mx-auto px-4">
              <div className="max-w-xl text-primary-foreground">
                <h3 className="text-3xl md:text-4xl font-bold mb-4">Conforto que se vê e se sente</h3>
